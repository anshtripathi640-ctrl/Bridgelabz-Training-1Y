...
class StringCompare {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Entersecond string: ");
		//if(boolean vale){}
        ...
        System.out.println("\nResult using charAt method comparison: " + charAtResult);
        System.out.println("Result using built-in equal method: " + equalsResult);
        if (charAtResult == equalsResult) {
            System.out.println("Both method produced the same result.");
        } else {
            System.out.println("The results from both methods different.");
        }
    }
}
